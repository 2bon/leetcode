...
如果使用迭代呢？ 我们首先应该想到的是树的各种遍历，由于我们求的是深度，因此 使用层次遍历（BFS）是非常合适的。 我们只需要记录有多少层即可。相关思路请查看[binary-tree-traversal](../suan-fa-zhuan-ti/binary-tree-traversal.md)
...
* [102.binary-tree-level-order-traversal](https://github.com/azl397985856/leetcode/tree/d8cd4f19bab3d9e98a2699afca2d1f6a262a3244/problems/102.binary-tree-level-order-traversal.md)
* [103.binary-tree-zigzag-level-order-traversal](https://github.com/azl397985856/leetcode/tree/d8cd4f19bab3d9e98a2699afca2d1f6a262a3244/problems/103.binary-tree-zigzag-level-order-traversal.md)
